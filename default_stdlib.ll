...
declare i8 *@get_push_constant_ptr()
declare i8 *@get_uniform_ptr(i32 %set, i32 %binding)
declare i8 *@get_uniform_const_ptr(i32 %set, i32 %binding)
declare i8 *@get_storage_ptr(i32 %set, i32 %binding)
declare i8 *@get_input_ptr(i32 %id)
declare i8 *@get_output_ptr(i32 %id)
declare i8 *@get_private_ptr()
